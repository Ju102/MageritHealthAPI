...
namespace MageritHealthAPI.Controllers
{
    ...
    public class TiposMedicionController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<DetailsTipoMedicionModel>>> GetTiposMedicion()
        {
            ...
            {
                return StatusCode(500, new { mensaje = "Error al obtener los tipos de medición.", detalle = ex.Message });
            }
        }
        ...
        public async Task<ActionResult<DetailsTipoMedicionModel>> GetTipoMedicion(int id)
        {
            ...
            {
                return StatusCode(500, new { mensaje = "Error al obtener el tipo de medición.", detalle = ex.Message });
            }
        }
        #endregion
        ...
        public async Task<ActionResult> Post([FromBody] CreateUpdateTipoMedicionModel model)
        {
            try
            {
                ...
                if (creado)
                {
                    return CreatedAtAction(nameof(GetTipoMedicion), new { id = tipoMedicion.IdTipoMedicion }, new { mensaje = "Tipo de medición creado." });
                }
            ...
            {
                return StatusCode(500, new { mensaje = "Error al crear el tipo de medición.", detalle = ex.Message });
            }
        }
        ...
        public async Task<ActionResult> Put(int id, [FromBody] CreateUpdateTipoMedicionModel model)
        {
            ...
            {
                return StatusCode(500, new { mensaje = "Error al actualizar el tipo de medición.", detalle = ex.Message });
            }
        }
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            {
                return StatusCode(500, new { mensaje = "Error al eliminar el tipo de medición.", detalle = ex.Message });
            }
        }
        #endregion
    }
